...
num_neigh_array = [3, 5, 7, 9]
df_results = pd.DataFrame(columns=['Numero de vecinos', 'Normalizacion', 'Metodo reduccion de dimensionalidad', 'Dimensionalidad',
                                   'Precision'])
        ...
        for dim in dim_red:
            ...
            for num_pca in principal_comps:
                ...
                for k in num_neigh_array:
                    ...
                    res = knn_results.sum() / len(knn_results)
                    ...
                    if i >= 1:
                        ...
                        df_results.loc[pos_count] = [str(k), norm, dim, num_pca, res]
...
# Set the current directory
os.chdir('../')
Path = r'C:\Users\Oliver\Documents\Dokumente\Studium\M.Sc. UPM\Intelligencia Artificial Applicada\Trabajo\Knn_all_results.csv'
...
# Set the current directory
os.chdir('../')
Path = r'C:\Users\Oliver\Documents\Dokumente\Studium\M.Sc. UPM\Intelligencia Artificial Applicada\Trabajo\Knn_main_results.csv'
df_results.to_csv(Path, index=False, header=True)
